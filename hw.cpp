...
BasicTriangleMesh3D fancy2basic(FancyTriangleMesh3D fancy_mesh) {
    ...
    { // () fancy2basic
        ...
        FORNOW_UNUSED(fancy_mesh); // this is just here to temporarily remove unreferenced formal parameter compiler warning; please delete
...
void mesh_transform_vertex_positions_to_double_unit_box(int num_vertices, vec3 *vertex_positions) {
    { // () mesh_transform_vertex_positions_to_double_unit_box
        ...
        FORNOW_UNUSED(num_vertices);
        FORNOW_UNUSED(vertex_positions); // this is just here to temporarily remove unreferenced formal parameter compiler warning; please delete
